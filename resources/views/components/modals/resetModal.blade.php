<div class='fixed inset-0 bg-gray-900 opacity-80' x-show="showReset"
    x-transition:leave="transition ease-in duration-150"
    x-transition:leave-start="opacity-80 transform scale-100"
    x-transition:leave-end="opacity-0 transform scale-0">
</div>
<div class="bg-white text-gray-800 shadow-md max-w-sm h-48 m-auto rounded-md fixed inset-0" x-show="showReset"
    ...
    <div class='flex flex-col h-full justify-between'>
        ...
        <footer class='flex justify-end space-x-4 bg-gray-200 rounded-b-md px-4 py-3'>
            <x-button class='bg-gray-800 hover:bg-gray-500' @click='showReset = false'>Cancel</x-button>
